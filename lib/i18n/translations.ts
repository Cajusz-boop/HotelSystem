...
export const messages: Record<Locale, Record<string, string | Record<string, string>>> = {
  pl: {
    sidebar: {
      ...
      logbook: "Księga meldunkowa",
      contractors: "Kontrahenci",
      guests: "Goście",
      companies: "Firmy",
      salesCenter: "Centrum Sprzedaży",
      ...
      parking: "Parking",
      centrumSprzedazy: "Centrum Sprzedaży",
      mice: "MICE",
      miceEvents: "Eventy",
  ...
  de: {
    sidebar: {
      ...
      channelManager: "Channel Manager",
      parking: "Parkplatz",
      centrumSprzedazy: "Verkaufszentrum",
      mice: "MICE",
