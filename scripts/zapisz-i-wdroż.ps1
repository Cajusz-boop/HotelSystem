# Zapisz zmiany do GitHuba i wdróż na hotel.karczma-labedz.pl
# Uzycie: .\scripts\zapisz-i-wdroż.ps1 "zapisz dane"
#         .\scripts\zapisz-i-wdroż.ps1 "poprawka formularza"
...
Write-Host "=== Zapisz i wdroż ===" -ForegroundColor Green
