...
function sanitizeEventData(body: Record<string, unknown>) {
  ...
  return {
    ...
    depositPaymentMethod: (b.depositPaymentMethod != null && ["CASH", "CARD", "TRANSFER", "VOUCHER"].includes(String(b.depositPaymentMethod))) ? String(b.depositPaymentMethod) : undefined,
...
function toCreateData(sanitized: ReturnType<typeof sanitizeEventData>): Prisma.EventOrderCreateInput {
  ...
  const data: Prisma.EventOrderCreateInput = {
    ...
    depositPaymentMethod: sanitized.depositPaymentMethod ?? null,
